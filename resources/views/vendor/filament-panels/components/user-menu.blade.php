...
>
    <x-slot name="trigger">
        <button
            ...
            aria-label="{{ __('filament-panels::layout.actions.open_user_menu.label') }}"
            type="button"
            class="flex items-center justify-center gap-x-3 shrink-0" {{-- Tambahkan gap-x-3 --}}
        >
            <x-filament-panels::avatar.user :user="$user" />

            {{-- 2. Teks Nama & Role (Kita Tambahkan Di Sini - Sebelah Kanan) --}}
            ...
            {{-- 3. Opsi Tambahan: Panah Bawah (Chevron) agar user tahu ini bisa diklik --}}
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-gray-500 hidden lg:block">
